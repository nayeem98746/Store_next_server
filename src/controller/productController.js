...
const updateProduct = async (req, res) => {
  try {
    ...
    // Recalculate discount price if discount or main_price changes
    if (updateData.discount && updateData.main_price) {
      const discountAmount = (parseFloat(updateData.main_price) * parseFloat(updateData.discount)) / 100;
      updateData.discount_price = parseFloat(updateData.main_price) - discountAmount;
    }
